...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # aes-256, rsa-2048, ec-p256, kyber1024
        ...
        sa.Column(
            "security_level", sa.String(16), nullable=False, server_default="CONTAINER"
        ),
        sa.Column("created_at", sa.String(64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "format", sa.String(8), nullable=False, server_default="V1"
        ),  # V1 / V2
        sa.Column(
            "security_level", sa.String(16), nullable=False, server_default="CONTAINER"
        ),
        ...
        sa.Column(
            "total_size", sa.BigInteger, nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "used_size", sa.BigInteger, nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "file_count", sa.Integer, nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "dedup_enabled", sa.Boolean, nullable=False, server_default=sa.text("1")
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "require_mfa", sa.Boolean, nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "token_required", sa.Boolean, nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
